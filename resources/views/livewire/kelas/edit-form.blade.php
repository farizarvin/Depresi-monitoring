    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="h2" id="edit-modal-label">Form Edit Kelas</h1>
                ...
                <div class="d-flex justify-between w-100">
                    <form action="" method="POST" class="col-12"  wire:submit="save()">
                        ...
                        <div class="form-group">
                            ...
                            <x-form-error-text :field="'form.nama'" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <x-form-error-text :field="'form.jenjang'" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <x-form-error-text :field="'form.jurusan'" />
                        </div>
